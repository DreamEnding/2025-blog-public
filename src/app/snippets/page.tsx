...
export default function Page() {
	...
	useEffect(() => {
		loadLegacyJson<string[]>('src/app/snippets/list.json').then(value => {
			setSnippets(value)
			setOriginalSnippets(value)
			setCurrentSnippet(getRandomSnippet(value))
		}).catch(console.error)
	}, [])
	...
	const buttonText = isAuth ? '保存' : '登录后台'
